...
USO — INDEXAR
  ...
  Artigos (uma ou várias URLs; pode colar várias no mesmo argumento separadas por espaço):
...
# Debug NDJSON (sessão Cursor) — remover após validação
DEBUG_LOG_PATH = "/media/joao/240ssd/project/.cursor/debug-3f40df.log"
DEBUG_SESSION_ID = "3f40df"
...
def menu() -> None:
    ...
    while True:
        ...
        _titulo("  INDEXAR")
        _sep()
        _item("1", "📄", "Artigos por URL",        "cole várias URLs: linhas, espaço ou vírgula")
